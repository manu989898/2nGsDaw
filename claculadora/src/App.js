...
//ehant to create some initial expenses and then store them in local storage 
...
const initialExpenses = localStorage.getItem("expenses")?
  ...
  const basicExpenses = [
    ...
    { id: nanoid(), charge: "car payment", amount: 400 },
    { id: nanoid(), charge: "credit card bill", amount: 1200 },
  ];

export default function App() {
  // All expenses, add expense
  const [expenses, setExpenses] = useState(basicExpenses && initialExpenses);
