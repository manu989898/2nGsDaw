    ...
    if (!empty($id)) {
        ...
        if ($customer) {
            ...
            if ($customer->destroy()) {
                ...
                $customer = null; // Limpiar los datos después de eliminar
            } else {
...
<head>
    <meta charset="UTF-8">
    <title>Buscar y Eliminar Customer</title>
    <style>
        body {
...
<body>
    ...
    <form method="post" action="">
        <label for="id">ID del Customer:</label>
    ...
    <?php if ($customer): ?>
        ...
        <p>ID: <?php echo htmlspecialchars($customer->getCustomerId()); ?></p>
        <p>Nombre: <?php echo htmlspecialchars($customer->getCustFirstName()); ?></p>
        <p>Correo: <?php echo htmlspecialchars($customer->getCustEmail()); ?></p>
        </div>
