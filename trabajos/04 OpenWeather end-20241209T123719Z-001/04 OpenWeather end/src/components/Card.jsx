...
export default function Card({loading, show, weather, forecast}){
   ...
   return(
            ...
            <div className="row g-0">
               ...
               <div className="col-md-8">
                  <div className="card-body text-start mt-2">
                     <h5 className="card-text">Maximum temperature: {KelvinToCelcius(weather.main.temp_max,1,true)}</h5>
                     <h5 className="card-text">Minimum temperature: {KelvinToCelcius(weather.main.temp_min,1,true)}</h5>
                     <h5 className="card-text">Feels like: {KelvinToCelcius(weather.main.feels_like,1,true)}</h5>
      ...
      :<h2 className="text-light">No text to show</h2>}
   </div>
   )
}
